package io.petros.posts.util.rx;
...
public class RxSchedulers {
    ...
    /**
     * A {@link Scheduler} intended for IO-bound work. The implementation is backed by an {@link java.util.concurrent.Executor}
     * thread-pool that will grow as needed. This can be used for asynchronously performing blocking IO.
     */
    private final Scheduler ioScheduler;

    /**
     * A {@link Scheduler} intended for computational work. This can be used for event-loops, processing callbacks and other
     * computational work. Unhandled errors will be delivered to the scheduler Thread's {@link Thread.UncaughtExceptionHandler}.
     **/
    ...
    public RxSchedulers(final Scheduler ioScheduler, final Scheduler computationScheduler, final Scheduler trampolineScheduler,
                        final Scheduler androidMainThreadScheduler) {
